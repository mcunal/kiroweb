    ...
    return (
        <div className="hakkimizda-container">
            <div className="hakkimizda-content">
                ...
                <p>
                    Bu yolculukta, KTÜ'nün bize sağladığı akademik altyapı ve girişimcilik ruhundan güç alıyoruz. Her bir ürünümüz, saatlerce süren araştırmanın, yaratıcı beyin fırtınalarının ve titiz bir çalışmanın eseridir. Lüminesans olarak, sadece bir marka olmanın ötesinde, bilimi sevdiren ve genç girişimcilere ilham veren bir topluluk olmayı hedefliyoruz.
                </p>
                <p className="hakkimizda-signature">
                    Bizimle parlayan bu heyecan verici serüvene katıldığınız için teşekkür ederiz!
                </p>
            </div>
        </div>
    );
